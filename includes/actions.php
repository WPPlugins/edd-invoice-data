...
function bpmj_edd_invoice_data_validate_invoice( $valid_data, $data ) {
	...
	if ( isset( $_POST[ 'bpmj_edd_invoice_data_invoice_check' ] ) && $_POST[ 'bpmj_edd_invoice_data_invoice_check' ] == 1 ) {
		...
		if ( !$is_company && (empty( $data[ 'bpmj_edd_invoice_data_invoice_person_name' ] ) || strlen( $data[ 'bpmj_edd_invoice_data_invoice_person_name' ] ) < 3) ) {
		...
		if ( empty( $data[ 'bpmj_edd_invoice_data_invoice_postcode' ] ) || strlen( $data[ 'bpmj_edd_invoice_data_invoice_postcode' ] ) < 5 ) {
...
function bpmj_edd_invoice_data_unrequire_fname( $required_fields ) {
...
add_filter( 'edd_purchase_form_required_fields', 'bpmj_edd_invoice_data_unrequire_fname' );
?>